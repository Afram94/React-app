...
export default function CheckOut() {
  ...
  const clear = () => {
    ...
    <div className="flex justify-center" >
        <div className="grid grid-cols-7 h-auto w-[1200px]">
        <div className="md:col-span-7 col-span-1 h-[100px] font-bold flex justify-center py-8 text-3xl text-[#F01E82]">Check out</div>
            <div className="relative col-span-4 mx-4 flex justify-center py-4 shadow-lg my-2 ease-in-out hover:shadow-2xl rounded-lg">
                <div className="grid grid-cols-4 w-full bg-cover bg-center bg-no-repeat" style={{backgroundImage: "url(" + Kontakt_2 + ")"}}>
            ...
            <div className="relative col-span-3 mx-8 flex py-4 flex-col shadow-lg my-2 ease-in-out hover:shadow-2xl rounded-lg w-[350px] ">
                <h2 className="py-4 mb-6 border-b text-sm font-medium flex justify-center text-[#F01E82] text-[20px]">Produkter du valde</h2>
                <div className="mx-8">
                    {getCartProds()}
                </div>
            </div>
