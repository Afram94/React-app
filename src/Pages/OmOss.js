...
export default function Home() {
  return(
    <Side_Master inner={
      <div className='relative w-full flex-wrap grid place-items-center'>
        ...
        <div className='grid-cols-2 flex-wrap px-4 md:w-3/4 flex justify-center my-4'>
          <div className='grid-rows-2 h-full flex-col items-center col-start-1 col-span-1'>
            ...
            <div className='row-start-2 row-span-1'>
              <p class="max-w-xl ml-2 mt-5 mx-auto text-xl text-gray-500">Ettasympatiskt och kompetent gäng som sätter service till kunden före allt.</p>
            </div>
          </div>

          <div className='h-full flex items-center justify-center col-start-2 col-span-1'>
            <img src={Om_oss_art_1} className='w-[400px]' /> {/* style={{height: "1.5vw"}} */}
          </div>
        ...
        <div className='grid-cols-2 flex-wrap px-4 md:w-3/4 flex justify-center my-24'>
          <div className='grid-rows-2 h-full flex-col items-center col-start-1 col-span-1'>
            <div className='row-start-1 row-span-1'>
              <p class="mt-1 text-4xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight lg:text-4xl">Bakgrund</p>
            </div>
            <div className='row-start-2 row-span-1'>
              <p class="max-w-xl ml-2 mt-5 mx-auto text-xl text-gray-500">Smart Cash grundades 2010 och är idag ett väletablerat bolag inom kassabranschen. Vi har genom åren byggt upp en gedigen kompetens för att tillgodose behovet av ett säkert och tillförlitligt betalsystem åt våra kunder.</p>
            </div>
          </div>
        </div>
        ...
        <div className='grid-cols-2 flex-wrap px-4 md:w-3/4 flex justify-center my-4 mt-12'>
          ...
          <div className='h-full flex items-center justify-center col-start-2 col-span-1'>
            <img src={Om_oss_art_3} className='w-[400px]' /> {/* style={{height: "1.5vw"}} */}
          </div>
        </div>

        <div className='grid-cols-2 flex-wrap px-4 md:w-3/4 flex justify-center my-4 mt-12'>
          <div className='h-full flex items-center justify-center col-start-2 col-span-1'>
            <img src={Om_oss_art_4} className='w-[400px]' /> {/* style={{height: "1.5vw"}} */}
          </div>
