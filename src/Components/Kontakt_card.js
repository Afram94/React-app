...
export default function Kontakt_card() {
  ...
  return (
    <div className='relative w-full md:h-[600px] flex justify-center mb-8'>
      <div className='grid-cols-6 w-full h-full flex-wrap shadow-lg duration-500 ease-in-out hover:shadow-2xl hidden md:grid'>
        ...
        <div className='col-start-3 col-span-4 bg-slate-50 grid-rows-5 lg:px-8 py-4 gap-4 grid bg-cover bg-center' style={{backgroundImage: "url(" + Kontakt_2 + ")"}}>
          ...
          <div className='relative row-start-4 row-span-1 flex'>
          ...
          {/* <div className='row-start-5 row-span-1 flex px-4'>
            <Btn_std ClassName={"flex bg-gradient-to-tr from-[#b300b3] to-[#ff06fe] text-white py-[6px] px-4 rounded-md w-[200px] font-medium"} bg={0} trigger={() => sendEmail()} inner="Skicka" />
          </div> */}
        </div>
      </div>
