  ...
  return(
    <div className='w-4/5 lg:w-full relative rounded-t-2xl shadow-md lg:shadow-none bg-white lg:bg-[#FFFFFF00] md:mt-52 mt-28 lg:mt-0 '>
      <div className=' py-6 text-left'>
        ...
        <h2 class="text-lg sm:text-4xl font-extrabold tracking-tight lg:text-white text-gray-600 px-4 text-center" data-v-0dd2ab72=""> VAD ERBJUDER VI? </h2>
        <p class="mt-4 text-lg sm:text-lg lg:text-white text-gray-600 font-medium px-4 text-center" data-v-0dd2ab72=""> Smart Cash är ett väletablerat bolag i kassabranschen och erbjuder de absolut senaste funktionerna som marknaden efterfrågar. Vi strävar alltid efter att ge våra kunder en unik kundupplevelse med förstklassig service, oavsett företagsstorlek. </p>
