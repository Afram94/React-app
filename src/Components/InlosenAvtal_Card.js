...
export default function InlosenAvtal_Card(props) {
  ...
  return (
    <div className=" w-full h-[800px] bg-contain " style={{backgroundImage: "url(" + group_bg + ")"}}>
      ...
      <div className={"h-[780px] relative py-6 px-6 rounded-2xl transition duration-500 hover:shadow-2xl hover:bg-white max-w-xl mx-auto flex justify-center " + props.className}>
        <div className="grid grid-cols-4 w-full gap-y-8 gap-x-6">
          ...
          <div className="col-span-2 px-2 py-2">
            ...
            <div className="py-[43px]">
                <button onClick={()=>sendEmail()} className="flex bg-gradient-to-tr from-[#b300b3] to-[#ff06fe] text-white py-[6px] px-4 rounded-md w-[200px]" > Skicka direkt </button>
            </div>
          </div>
        </div>
